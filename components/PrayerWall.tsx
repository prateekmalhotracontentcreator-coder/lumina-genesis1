    ...
    <div className="space-y-8 relative">
      ...
      <div className="space-y-4">
        ...
        {cards.length > 3 && (
          <button 
            onClick={() => setShowHistory(true)}
            className="w-full py-4 text-[10px] font-bold uppercase tracking-widest text-white/20 hover:text-white transition-all"
          >
            View all {cards.length} entries in Archive
          </button>
        )}
      </div>
    </div>
