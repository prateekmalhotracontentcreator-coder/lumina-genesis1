  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="text-center mb-8">
        <h2 className="text-2xl serif font-bold">21-Day Manifestation</h2>
        <p className="text-xs text-white/40 mt-1">Transforming your life through faith and word.</p>
      </div>
      ...
      <div className="glass p-8 shadow-xl space-y-6 mt-8 relative overflow-hidden">
        ...
        <div>
          <h3 className="text-xl serif italic mb-2">Day {currentDay}: {dayData.title}</h3>
          <p className="text-sm text-white/70 leading-relaxed italic border-l-2 border-white/10 pl-4 mb-6">
            "{dayData.verse}"
          </p>
        ...
        <textarea 
          ...
          className="w-full h-32 bg-black/20 border border-white/10 rounded-xl p-4 text-sm outline-none focus:border-white/30"
        />
