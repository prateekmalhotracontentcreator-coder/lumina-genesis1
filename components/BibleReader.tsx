...
const BibleReader: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-20">
      {/* Search & Controls */}
      <div className="glass p-4 space-y-4 shadow-xl border-white/10">
        <form onSubmit={handleSearch} className="relative">
          <input 
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            placeholder="Search Book & Chapter (e.g. 'Psalm 23')..."
            className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-sm outline-none focus:border-indigo-500/50 transition-all"
          />
        ...
        <div className="flex justify-between items-center">
          <select 
            ...
            className="bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-xs font-bold outline-none uppercase tracking-widest"
          >
      ...
      {/* Reader Area */}
      <div className="glass p-8 leading-relaxed space-y-8 shadow-2xl relative min-h-[450px] flex flex-col justify-center">
        {loading ? (
          ...
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="space-y-6">
              <div className="text-xl leading-relaxed font-light text-white/90 serif italic">
      ...
      <div className="glass p-4 bg-indigo-900/20 border border-indigo-500/20 flex items-center justify-between">
        ...
        <a 
          ...
          className="bg-red-600 text-white px-4 py-2 rounded-full text-[10px] font-bold uppercase"
        >
          YouTube Link
        </a>
      </div>
