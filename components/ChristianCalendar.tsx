  ...
  return (
    <div className="space-y-6">
      <div className="glass p-6">
        ...
        <p className="text-xs text-white/40">Tracking the sacred rhythms of the faith.</p>
      </div>
      ...
      <div className="glass p-6 text-center border-dashed border-white/20">
        <p className="text-xs text-white/60">"To everything there is a season, a time for every purpose under heaven."</p>
        <p className="text-[10px] text-white/30 mt-2 font-bold">— Ecclesiastes 3:1</p>
      </div>
    </div>
  );
};
