  ...
  return (
    <div className="space-y-8">
      <div className="glass p-8 text-center bg-gradient-to-b from-blue-900/40 to-black/40 border-t border-blue-400/20">
        <div className="w-20 h-20 glass rounded-full mx-auto mb-6 flex items-center justify-center text-4xl animate-pulse">🌙</div>
        <h2 className="text-2xl serif font-bold mb-2 text-white">Rest in the Word</h2>
